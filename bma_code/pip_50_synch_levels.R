...
ar.synch.levels.pip50.1 = lm(synch ~ country  + draghisynch_lag1+ draghisynch_lag2+ recsynch_lag1 +
                               recsynch_lag2 +synch_lag1+ zlbsynch_lag1+ zlbsynch_lag2+ zlbsynch_lag3+d_2002+ d_2003+ d_2004+ d_2005+ d_2006+ d_2007+
                   d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018, data = synch_levels_data_pip %>% 
                   filter(date <= as.Date("2018-10-01"))) 
...
ar.synch.levels.pip50.2 = lm(synch ~  country  + draghiinflation_lag3+ draghiinflation_lag4+ draghisynch_lag1+
                   ...
                   d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018+d_2019, data = synch_levels_data_pip %>% 
                   mutate(date = as.Date(date)) %>% 
                   filter(date <= as.Date("2019-01-01"))) 

ar.synch.levels.pip50.3 = lm(synch ~ country + draghisynch_lag1 +draghisynch_lag2+ recsynch_lag1 +recsynch_lag2+
                               synch_lag1+ zlbsynch_lag1 +zlbsynch_lag2 +zlbsynch_lag3+d_2002+ d_2003+ d_2004+ d_2005+ d_2006+ d_2007+
                   d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018+d_2019, data = synch_levels_data_pip %>% 
                   mutate(date = as.Date(date)) %>% 
...
ar.synch.levels.pip50.4 = lm(synch ~  country  + draghisynch_lag1+ draghisynch_lag2 +draghisynch_lag3+ recsynch_lag1 +
                               synch_lag1 +zlbsynch_lag1 +zlbsynch_lag2+d_2002+ d_2003+ d_2004+ d_2005+ d_2006+ d_2007+
                   d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018+d_2019, data = synch_levels_data_pip %>% 
                   mutate(date = as.Date(date)) %>% 
...
ar.synch.levels.pip50.5 = lm(synch ~ country +draghisynch_lag1 +draghisynch_lag2 +draghisynch_lag3+ recsynch_lag1+
                               recsynch_lag2 +synch_lag1 +zlbsynch_lag1+ zlbsynch_lag2+d_2002+ d_2003+ d_2004+ d_2005+ d_2006+ d_2007+
                               d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018+d_2019, data = synch_levels_data_pip %>% 
                   mutate(date = as.Date(date)) %>% 
...
ar.synch.levels.pip50.6 = lm(synch ~ country + draghisynch_lag1+ draghisynch_lag2+ draghisynch_lag3+ recsynch_lag1+
                               recsynch_lag2 +synch_lag1 +zlbsynch_lag1+ zlbsynch_lag2+d_2002+ d_2003+ d_2004+ d_2005+ d_2006+ d_2007+
                   d_2008+ d_2009+ d_2010+ d_2011+ d_2012+ d_2013+ d_2014+ d_2015+ d_2016+ d_2017 +d_2018+d_2019+d_2020, data = synch_levels_data_pip %>% 
                   mutate(date = as.Date(date)) %>% 
